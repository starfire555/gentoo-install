...
echo 'gentoo-bb:/hdd1    /mnt/nfs/gentoo-bb/hdd1    nfs    rw,_netdev    0    0' >> /etc/fstab
echo 'gentoo-bb:/hdd2    /mnt/nfs/gentoo-bb/hdd2    nfs    rw,_netdev    0    0' >> /etc/fstab
echo 'gentoo-pro:/hdd1   /mnt/nfs/gentoo-pro/hdd1   nfs    rw,_netdev    0    0' >> /etc/fstab
